...
def get_columns(filters):
	...
	,
		...
		{"label": _("Against Account"), "fieldname": "against", "width": 120, "hidden": 1},
	...
	if filters.get("include_dimensions"):
		for dim in get_accounting_dimensions(as_list=False):
			columns.append(
				{"label": _(dim.label), "options": dim.label, "fieldname": dim.fieldname, "width": 100, "hidden": 1}
			)
		columns.append(
	...
	columns.extend(
		[
			{"label": _("Against Voucher Type"), "fieldname": "against_voucher_type", "width": 100, "hidden": 1},
			{
			...
			{"label": _("Supplier Invoice No"), "fieldname": "bill_no", "fieldtype": "Data", "width": 100, "hidden": 1},
			{"label": _("Remarks"), "fieldname": "remarks", "width": 400, "hidden": 1},
		]
	)
